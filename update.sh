#!/usr/bin/env bash
# Update claude-package-kit to the newest GitHub Release, then re-run the installer.
#
...
# version number sorts. This downloads that release's claude-package-kit.tar.gz
