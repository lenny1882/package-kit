---
name: release
description: Cut a new __PKG__ release — bump VERSION on main, merge main into the matching release/vX.x branch, and tag there so the GitHub Actions release workflow publishes it. Use when the user asks to cut, ship, or publish a new release/version of this repo.
---

# Cutting a __PKG__ release
